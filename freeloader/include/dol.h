...
#define dol_sect_offset(hptr, index)                                                                                   \
	((index >= DOL_SECT_MAX_TEXT) ? hptr->offset_data[index - DOL_SECT_MAX_TEXT] : hptr->offset_text[index])
#define dol_sect_address(hptr, index)                                                                                  \
	((index >= DOL_SECT_MAX_TEXT) ? hptr->address_data[index - DOL_SECT_MAX_TEXT] : hptr->address_text[index])
#define dol_sect_size(hptr, index)                                                                                     \
	((index >= DOL_SECT_MAX_TEXT) ? hptr->size_data[index - DOL_SECT_MAX_TEXT] : hptr->size_text[index])
#define dol_sect_is_text(hptr, index) ((index >= DOL_SECT_MAX_TEXT) ? 0 : 1)
